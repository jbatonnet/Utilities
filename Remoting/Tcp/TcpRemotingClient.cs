...
namespace Utilities.Remoting.Tcp
{
    ...
    public class TcpRemotingClient : RemotingClient
    {
        ...
        public TcpRemotingClient(string host, ushort port)
        {
            ...
            Stream blockingStream = new BlockingStream(networkStream);
            //blockingStream = new DebugStream(blockingStream, "Client");

            muxerStream = new MuxerStream(blockingStream) { Marker = "Client" };
